...
to a variable using const are still mutable. Using the const declaration only prevents 
...
to the altered array [5, 6, 45]. Like all arrays, the array elements in s are mutable, 
but because const was used, you cannot use the variable identifier s to point to a different 
