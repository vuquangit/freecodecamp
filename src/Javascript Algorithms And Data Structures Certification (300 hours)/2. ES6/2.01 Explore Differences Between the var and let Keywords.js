...
overwrite variable declarations without an error.
    ...
    console.log(camper);
    // logs 'David'
As you can see in the code above, the camper variable is originally declared as James and 
then overridden to be David.

In a small application, you might not run into this type of problem, but when your code 
becomes larger, you might accidentally overwrite a variable that you did not intend to overwrite.
...
Note the "use strict". This enables Strict Mode, which catches common coding mistakes and 
