...
1) Don't alter a variable or object - create new variables and objects and return them if 
need be from a function.
...
Adding one to a number is not very exciting, but we can apply these principles when working 
...
The add function should add the given bookName to the end of an array. The remove function 
