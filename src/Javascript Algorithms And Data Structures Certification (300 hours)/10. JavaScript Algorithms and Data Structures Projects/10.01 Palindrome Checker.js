...
const palindrome = str => {
  let strCheck = str.replace(/\W|_/g, "").toLowerCase();
  for (let i = 0; i < parseInt(strCheck.length / 2); i++) {
    if (strCheck[i] !== strCheck[strCheck.length - i - 1]) return false;
  }
  return true;
};

console.log(palindrome("_ey   */  E")); // true
...
console.log(palindrome_2("race car")); //true
