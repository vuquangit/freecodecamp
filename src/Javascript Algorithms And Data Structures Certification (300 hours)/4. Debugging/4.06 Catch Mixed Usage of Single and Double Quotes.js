...
Having two choices is great when a string has contractions or another piece of text that's in 
quotes. Just be careful that you don't close the string too early, which causes a syntax error.
...
Of course, it is okay to use only one style of quotes. You can escape the quotes inside the 
