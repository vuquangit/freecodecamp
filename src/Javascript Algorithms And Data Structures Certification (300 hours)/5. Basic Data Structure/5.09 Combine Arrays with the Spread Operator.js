...
all the elements of one array into another, at any index. With more traditional syntaxes, 
...
using the spread operator so that it returns the array ['learning', 'to', 'code', 'is', 'fun'].
    function spreadOut() {
