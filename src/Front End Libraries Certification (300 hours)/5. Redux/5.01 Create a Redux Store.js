...
This is the first important principle to understand when learning Redux: the Redux store is the 
...
reducer function as a required argument. The reducer function is covered in a later challenge, 
...
value of 5. If you're not familiar with default arguments, you can refer to the ES6 section in the 
Curriculum which covers this topic.
...
class Redux extends React.Component {
  render() {
    return <div>{"const store  = Redux.createStore(reducer);"}</div>;
  }
}
