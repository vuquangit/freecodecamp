...
there is one important point to note. Rendering ES6 style class components within other 
components is no different than rendering the simple components you used in the last few 
challenges. You can render JSX elements, stateless functional components, and ES6 class 
...
into the TypesOfFood component, below the h1 header and above Vegetables. The result should 
...
import { NonCitrus, Citrus, Vegetables } from "./ComponentsBackground";
